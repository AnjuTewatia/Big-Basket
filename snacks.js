...
fetch(' https://api.spoonacular.com/food/search?query=snacks&apiKey=16a7ab4f21a24c6aba65724240f8792e', options)
	.then(response => response.json())
	.then(data => appendSnacks(data.searchResults[1].results))
	.catch(err => console.log(err));

let snacks_images = ["https://www.bigbasket.com/media/uploads/banner_images/YXPL14344-1200x300-25thsep.jpg","https://www.bigbasket.com/media/uploads/banner_images/YXPL14137-1200x300-25thsep.jpg","https://www.bigbasket.com/media/uploads/banner_images/YXPL14106-1200x300-25thsep.jpg","https://www.bigbasket.com/media/uploads/banner_images/YXPL14941-1200x300-25thsep.jpg"];
let img = document.createElement("img");
let snacks_slider = document.getElementById("snacks_slider");
let i = 0;
setInterval(function(){
if(i===3){i=0}
    img.src = snacks_images[i];
    snacks_slider.innerHTML = null;
    snacks_slider.append(img);
    i++;
    },3000);
...
function appendSnacks(data){
    ...
    while(i<=10){
        ...
        document.getElementById("snacks_container").append(div);
        i++;
    }
   }

   let count = 0;
document.getElementById("more_snacks").addEventListener('click',(e)=>{
    const options = {
        method: 'GET',
        Headers : {
            "Content-Type" : "application/json",
...
fetch(' https://api.spoonacular.com/food/search?query=cookies&apiKey=16a7ab4f21a24c6aba65724240f8792e', options)
        .then(response => response.json())
        .then(data => appendSnacks(data.searchResults[1].results)
        .catch(err => console.log(err)))
  }) ; 